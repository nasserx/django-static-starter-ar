...
The template is development-friendly by default and is not production-safe out of the box. Expected deployment-check warnings for the development starter can include:
...
Resolve these warnings in the consuming project before deploying to production.
